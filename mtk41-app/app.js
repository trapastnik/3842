 ...
 * `<script src="./app.js?v=37">` обновит только сам app.js, а его
...
import { canonScene } from "./scenes/canon.js?v=37";
import { authorsScene } from "./scenes/authors.js?v=37";
import { scaleScene } from "./scenes/scale.js?v=37";
import { mapScene } from "./scenes/map.js?v=37";
import { timelineScene } from "./scenes/timeline.js?v=37";
import { silhouettesScene } from "./scenes/silhouettes.js?v=37";
import { stackedScene } from "./scenes/stacked.js?v=37";
