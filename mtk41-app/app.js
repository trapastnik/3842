 ...
 * `<script src="./app.js?v=65">` обновит только сам app.js, а его
...
import { canonScene } from "./scenes/canon.js?v=65";
import { authorsScene } from "./scenes/authors.js?v=65";
import { scaleScene } from "./scenes/scale.js?v=65";
import { mapScene } from "./scenes/map.js?v=65";
import { timelineScene } from "./scenes/timeline.js?v=65";
import { silhouettesScene } from "./scenes/silhouettes.js?v=65";
import { stackedScene } from "./scenes/stacked.js?v=65";
