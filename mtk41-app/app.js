 ...
 * `<script src="./app.js?v=66">` обновит только сам app.js, а его
...
import { canonScene } from "./scenes/canon.js?v=66";
import { authorsScene } from "./scenes/authors.js?v=66";
import { scaleScene } from "./scenes/scale.js?v=66";
import { mapScene } from "./scenes/map.js?v=66";
import { timelineScene } from "./scenes/timeline.js?v=66";
import { silhouettesScene } from "./scenes/silhouettes.js?v=66";
import { stackedScene } from "./scenes/stacked.js?v=66";
