 ...
 * `<script src="./app.js?v=36">` обновит только сам app.js, а его
...
import { canonScene } from "./scenes/canon.js?v=36";
import { authorsScene } from "./scenes/authors.js?v=36";
import { scaleScene } from "./scenes/scale.js?v=36";
import { mapScene } from "./scenes/map.js?v=36";
import { timelineScene } from "./scenes/timeline.js?v=36";
import { silhouettesScene } from "./scenes/silhouettes.js?v=36";
import { stackedScene } from "./scenes/stacked.js?v=36";
