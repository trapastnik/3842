 ...
 * `<script src="./app.js?v=30">` обновит только сам app.js, а его
...
import { canonScene } from "./scenes/canon.js?v=30";
import { authorsScene } from "./scenes/authors.js?v=30";
import { scaleScene } from "./scenes/scale.js?v=30";
import { mapScene } from "./scenes/map.js?v=30";
import { timelineScene } from "./scenes/timeline.js?v=30";
import { silhouettesScene } from "./scenes/silhouettes.js?v=30";
import { stackedScene } from "./scenes/stacked.js?v=30";
