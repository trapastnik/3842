 ...
 * `<script src="./app.js?v=44">` обновит только сам app.js, а его
...
import { canonScene } from "./scenes/canon.js?v=44";
import { authorsScene } from "./scenes/authors.js?v=44";
import { scaleScene } from "./scenes/scale.js?v=44";
import { mapScene } from "./scenes/map.js?v=44";
import { timelineScene } from "./scenes/timeline.js?v=44";
import { silhouettesScene } from "./scenes/silhouettes.js?v=44";
import { stackedScene } from "./scenes/stacked.js?v=44";
