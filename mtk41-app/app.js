 ...
 * `<script src="./app.js?v=21">` обновит только сам app.js, а его
...
import { canonScene } from "./scenes/canon.js?v=21";
import { authorsScene } from "./scenes/authors.js?v=21";
import { scaleScene } from "./scenes/scale.js?v=21";
