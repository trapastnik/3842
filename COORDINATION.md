...
- **2026-07-08 (xenodochial-goodall → coord)**: **Просьба к координатору — вынести настройку диагональных полос фона (red + brass 105°) в хаб.** Полосы одинаковые на всех МТК, логичнее иметь один общий контрол в хаб-баре (яркость 0-100%), а не дублировать в каждой сессии.
