...
1. **Объём языков v2 = 52** (canonical-список по PDF; на листе 52 надписи — 50 подписанных + рус./лат. опоры). Архитектуру `data/mtk38.json` делаем масштабируемой, но контент и шрифты — под 52. Не гонимся за 134.
