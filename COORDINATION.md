...
| Зона | Владелец |
|---|---|
| `mtk38-*/` (v1), `mtk38-v2/`, `mtk38-v3/`, `mtk38-handoff/`, `data/mtk38.json`, `assets/mtk38/` | **`mtk38`** (ветка `claude/mtk38`, worktree `.claude/worktrees/mtk38/`; с 2026-07-07 — единая каноническая линия МТК 38) |
