...
import { globeScene } from "./scenes/globe.js?v=24";
import { rainScene } from "./scenes/rain.js?v=24";
import { mapScene } from "./scenes/map.js?v=24";
import { catalogScene } from "./scenes/catalog.js?v=24";
import { compositionsScene } from "./scenes/compositions.js?v=24";
import { posterScene } from "./scenes/poster.js?v=9";
...
import { onStandbyStop, stopSceneStandby } from "./scenes/shared.js?v=24";
