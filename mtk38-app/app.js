...
import { globeScene } from "./scenes/globe.js?v=23";
import { rainScene } from "./scenes/rain.js?v=23";
import { mapScene } from "./scenes/map.js?v=23";
import { catalogScene } from "./scenes/catalog.js?v=23";
import { compositionsScene } from "./scenes/compositions.js?v=23";
import { posterScene } from "./scenes/poster.js?v=8";
...
import { onStandbyStop, stopSceneStandby } from "./scenes/shared.js?v=23";
