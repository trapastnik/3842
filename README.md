...
| # | Вариант | Идея | Интеракция |
|---|---|---|---|
| 01 | **Маятник** ([mtk42-pendulum/](mtk42-pendulum/)) | Точки в координатах (год, тон) на «оси оценки» от отрицания до почитания. Цвет точки — категория (red политики, brass исследователи, paper-grey литература). Скользящее среднее по десятилетию — траектория «маятника» общественного мнения. | Вертикальный скролл по годам, тап на точке — раскрывает карточку с ключевой работой и цитатой, если она есть. |
| 02 | **Картотека** ([mtk42-archive/](mtk42-archive/)) | Сетка карточек: портрет, имя, ключевая работа, эпоха, тон. Фильтры по 6 эпохам и 3 категориям. | Тап — компактная панель с биографией, ключевой работой и (если есть) цитатой в выделенном блоке. |
