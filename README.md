...
- `mtk39-globe/` · `mtk39-world/` · `mtk39-wave/` · `mtk39-streets/` · `mtk39-stats/` — 5 прототипов для МТК 39: избранный глобус, весь свод на глобусе, столетие имени на карте, гербарий улиц из OSM, статистика корпуса.
...
| 02 | **Мир** ([mtk39-world/](mtk39-world/)) | Весь свод на глобусе: 1 162 точки, цвет = судьба имени (носит / переименовано / утрачено) | Drag = вращение, тап = карточка, чипы-фильтры по судьбе имени; в простое глобус вращается сам |
