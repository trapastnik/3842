...
- `data/` — общая директория данных (геоконтуры, контентные json). Read-only для МТК 38; основной потребитель — bold-booth (МТК 39+).
...
for f in mtk38-*/[a-z]*.js; do node --check "$f"; done
```
