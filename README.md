...
- [`mtk41-scale`](mtk41-scale/) — в одном масштабе с человеком 1.75 м. У 52 памятников габаритов в источнике нет — они рисуются пунктиром с подписью «нет данных», а не подставной высотой.
