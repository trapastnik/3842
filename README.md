...
- [`mtk41-scale`](mtk41-scale/) — в одном масштабе, с человеком 1.75 м для сравнения. Реальные силуэты (rembg) при настоящих пропорциях.
- [`mtk41-silhouettes`](mtk41-silhouettes/) — типология силуэта: все 19 приведены к одной высоте, видны позы и архетипы (указующий, стоящий, сидящий, бюст, голова, группа).
