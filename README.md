...
Пять прототипов — пять метафор одного материала:
...
- [`mtk41-scale`](mtk41-scale/) — в одном масштабе, с человеком 1.75 м для сравнения. Бюст 0.6 м рядом с 57-метровым колоссом.
