...
<style>
  ...
  *{box-sizing:border-box}
  ...
  .lbl{font-size:10px;letter-spacing:.08em;text-transform:uppercase;color:var(--window);
    text-align:center;margin:7px 0 1px}
  .writing,.canon-str{font-size:clamp(34px,4.6vw,52px);line-height:1.15;text-align:center;
    min-height:54px;display:flex;align-items:center;justify-content:center;gap:.25em;flex-wrap:wrap}
  .writing{color:var(--amber-black)}
  .canon-str{color:var(--graphite);background:#eef0e6;border-radius:8px;padding:4px 10px;user-select:all}
  ...
  .cp{font-family:ui-monospace,Menlo,Consolas,monospace;font-size:10px;color:var(--window);
    text-align:center;word-break:break-all;margin:3px 0 0;user-select:all}
