...
import { createApp } from "../kiosk-core.esm.js?v=11";
...
import { pulseScene } from "./scenes/pulse.js?v=11";
import { gridScene } from "./scenes/grid.js?v=11";
import { cardsScene } from "./scenes/cards.js?v=11";
