...
import { createApp } from "../kiosk-core.esm.js?v=24";
...
import { pulseScene } from "./scenes/pulse.js?v=24";
import { gridScene } from "./scenes/grid.js?v=24";
import { cardsScene } from "./scenes/cards.js?v=24";
...
const app = createApp({
  ...
  i18nUrl: "./i18n/",
  i18nVersion: "24",   /* без метки Chrome держит старый словарь после обновления */
});
