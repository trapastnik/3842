...
import { createApp } from "../kiosk-core.esm.js?v=19";
...
import { pulseScene } from "./scenes/pulse.js?v=19";
import { gridScene } from "./scenes/grid.js?v=19";
import { cardsScene } from "./scenes/cards.js?v=19";
...
const app = createApp({
  ...
  i18nUrl: "./i18n/",
  i18nVersion: "19",   /* без метки Chrome держит старый словарь после обновления */
});
