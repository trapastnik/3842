...
import { createApp } from "../kiosk-core.esm.js?v=1.23.1";
...
import { pulseScene } from "./scenes/pulse.js?v=1.23.1";
import { gridScene } from "./scenes/grid.js?v=1.23.1";
import { cardsScene } from "./scenes/cards.js?v=1.23.1";
...
const app = createApp({
  ...
  i18nUrl: "./i18n/",
  i18nVersion: "1.23.1",   /* без метки Chrome держит старый словарь после обновления */
