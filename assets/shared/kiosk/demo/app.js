...
import { createApp } from "../kiosk-core.esm.js?v=1.12.0";
...
import { pulseScene } from "./scenes/pulse.js?v=1.12.0";
import { gridScene } from "./scenes/grid.js?v=1.12.0";
import { cardsScene } from "./scenes/cards.js?v=1.12.0";
...
const app = createApp({
  ...
  i18nUrl: "./i18n/",
  i18nVersion: "1.12.0",   /* без метки Chrome держит старый словарь после обновления */
