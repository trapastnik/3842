...
import { createApp } from "../kiosk-core.esm.js?v=22";
...
import { pulseScene } from "./scenes/pulse.js?v=22";
import { gridScene } from "./scenes/grid.js?v=22";
import { cardsScene } from "./scenes/cards.js?v=22";
...
const app = createApp({
  ...
  i18nUrl: "./i18n/",
  i18nVersion: "22",   /* без метки Chrome держит старый словарь после обновления */
});
