...
import { createApp } from "../kiosk-core.esm.js?v=16";
...
import { pulseScene } from "./scenes/pulse.js?v=16";
import { gridScene } from "./scenes/grid.js?v=16";
import { cardsScene } from "./scenes/cards.js?v=16";
