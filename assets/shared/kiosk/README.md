...
const app = createApp({
  ...
  i18nUrl: "./i18n/",
  i18nVersion: "7",                     // метка кеша словарей, поднимайте вместе с ?v=
});
...
```html
<link rel="stylesheet" href="../assets/shared/kiosk/kiosk.css?v=1.9.0" />
<link rel="stylesheet" href="../assets/shared/kiosk/kiosk-core.css?v=1.9.0" />
<script type="module" src="./app.js?v=1.9.0"></script>
```

```js
import { createApp } from "../assets/shared/kiosk/kiosk-core.esm.js?v=1.9.0";
import { mapScene }  from "./scenes/map.js?v=1.9.0";   // импорты сцен тоже!
```
