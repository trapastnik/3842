...
поднялось. Ядро теперь **само сверяет** свою версию с меткой в адресе, по
которому его запросили, и при расхождении пишет предупреждение в консоль и в
журнал: залипший кеш ловится кодом, а не глазами в отчёте.
