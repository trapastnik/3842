...
|---|------|-----------|--------|
| 0 | **Фундамент** | каталоги, базовый shell, bundled шрифты, киоск-обвязка, idle-таймер, проверка на 4K (горизонталь 3840×2160; вертикаль отменена 2026-07-22) | 1–2 дня |
...
| 7 | **Production-сборка и приёмка** | минификация, тест на целевом железе (49" 4K, горизонталь 3840×2160), failure recovery, логирование | 3–5 дней |
...
- **Формат — горизонталь 3840×2160** (решение 2026-07-22; вертикальный режим удалён из хаба и прототипных планов). Эргономика 49" тача: основные интерактивные элементы — в центральной полосе экрана, края — фон/декор.
